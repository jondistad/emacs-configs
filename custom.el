(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (purescript-mode racket-mode alchemist flycheck-mix jsx-mode flycheck-liquidhs liquid-types button-lock flycheck-color-mode-line pos-tip js2-mode auto-complete company go-mode sbt-mode scala-mode tide jdecomp monokai-theme ponylang-mode yaml-mode wgrep-ag tuareg toml-mode solarized-theme scheme-complete racer protobuf-mode paredit noflet nodejs-repl nginx-mode neotree multiple-cursors markdown-mode magit llvm-mode less-css-mode irony haml-mode go-errcheck go-eldoc go-autocomplete gherkin-mode ghc geiser flx-ido find-file-in-repository find-file-in-project fill-column-indicator feature-mode espuds dockerfile-mode cql-mode company-coq commander coffee-mode clojurescript-mode clojure-project-mode chicken-scheme caml ansi ag)))
